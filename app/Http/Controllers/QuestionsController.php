...
class QuestionsController extends Controller
{
    public function addQuestion ( Request $request ) {
        ...
        if ( $path != "" ) {
            ...
            $magicianObj = new imageLib('images/' . $path);
            $magicianObj -> resizeImage(300, 200);
            $magicianObj -> saveImage('images/questions/'.$rand . '.jpg', 80);
            $question->imagePath = 'questions/'.$rand . '.jpg' ;
